                        ...
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="tag-list"> <a class="item" title="Phone" href="<?php echo e(url('category')); ?>">Phone</a>
                                <a class="item active" title="Vest" href="<?php echo e(url('category')); ?>">Vest</a> <a
                                    ...
                                    title="Rose" href="<?php echo e(url('category')); ?>">Rose</a>
                            </div>
                            <!-- /.tag-list -->
                        </div>
                        <!-- /.sidebar-widget-body -->
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    ...
                    <div class="tab-content outer-top-xs">
                        <div class="tab-pane in active" id="all">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a
                                        href="<?php echo e(url('detail/' . $newProduct['id'])); ?>"><?php echo e($newProduct['name']); ?></a></h3>
                                <div class="description"><?php echo $newProduct['description']; ?></div>
                            ...
                            <div class="cart clearfix animate-effect">
                                <div class="action">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="add-cart-button btn-group">
                                            <button data-toggle="tooltip" class="btn btn-primary icon cooke"
                                                data-id="<?php echo e($newProduct['id']); ?>" type="button" title="Add Cart"> <i
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p7.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p11.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p12.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p13.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p14.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p15.jpg')); ?>" alt="image"></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p16.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p18.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img
                                            src="<?php echo e(asset('app\images\products\p17.jpg')); ?>" alt=""></a> </div>
                                <!-- /.image -->
...
function filterProducts() {
    ...
    $.ajax({
        url: "<?php echo e(route('filterProducts')); ?>",
        method: 'GET',
        data: {
            minPrice: minPrice,
            maxPrice: maxPrice
