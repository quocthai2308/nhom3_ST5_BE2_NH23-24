                                        ...
                                        <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        href="{{ url('category') }}">- Clothing</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        href="{{ url('category') }}">- Electronics</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        href="{{ url('category') }}">- Shoes</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                        href="{{ url('category') }}">- Watches</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown mega-menu">
                                        <a href="{{ url('category') }}" data-hover="dropdown"
                                                ...
                                                <div class="yamm-content">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="#"><img alt=""
                                                                    src="{{ asset('app\images\banners\banner-side.png') }}"></a>
                                                        </div>
                                                    </div>
                                                    <!-- /.row -->
                                                </div>
                                    ...
                                    <li class="dropdown hidden-sm"> <a href="{{ url('category') }}">Health & Beauty
