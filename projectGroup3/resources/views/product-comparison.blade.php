						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="{{asset ('app\images\products\p1.jpg')}}">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="{{asset ('app\images\products\p2.jpg')}}">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="{{asset ('app\images\products\p4.jpg')}}">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="{{asset ('app\images\products\p5.jpg')}}">
										</a>
									</div>
