                        ...
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="tag-list"> <a class="item" title="Phone" href="{{ url('category') }}">Phone</a>
                                <a class="item active" title="Vest" href="{{ url('category') }}">Vest</a> <a
                                    ...
                                    title="Rose" href="{{ url('category') }}">Rose</a> </div>
                            <!-- /.tag-list -->
                        </div>
                        <!-- /.sidebar-widget-body -->
                    </div>
                                                    ...
                                                    <div class="action">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li class="add-cart-button btn-group">
                                                                ...
                                                                <button class="btn btn-primary cart-btn add-to-cart cooke" data-id="{{ $newProduct['id'] }}" type="button">Add to cart</button>
                                                            </li>
                                    ...
                                    <div class="product">
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{url('/detail/'.$product->id)}}"> <img src="{{ asset("app/images/products/".$product->image_name) }}" alt=""> </a> </div>
                                                        <!-- /.image -->
