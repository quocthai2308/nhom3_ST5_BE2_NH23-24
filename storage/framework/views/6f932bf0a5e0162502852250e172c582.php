                    ...
                    <div class="col-md-9">
                        ...
                        <div style="margin-bottom: 10px;" class="blog-post wow fadeInUp">
                            <a href="blog-details.html">
                                <h1><a href="blog-details.html"><?php echo e($blog->title); ?></a>
                                </h1>
                                ...
                                <p> <?php $content = trim(strip_tags($blog['content']));
                                    ...
                                    echo $content;?></p>
                                <a href="<?php echo e(url("blog-details/".$blog->id)); ?>" class="btn btn-upper btn-primary read-more">read more</a>
                            </div>
                            ...
                            <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                                ...
                                <div class="tab-content" style="padding-left:0">
                                    <div class="tab-pane active m-t-20" id="popular">
                                        <div class="blog-post inner-bottom-30 ">
                                            <img class="img-responsive"
                                                src="<?php echo e(asset('app\images\blog-post\blog_big_01.jpg')); ?>"
                                                alt="">
                                        ...
                                        <div class="blog-post">
                                            <img class="img-responsive"
                                                src="<?php echo e(asset('app\images\blog-post\blog_big_02.jpg')); ?>"
                                                alt="">
                                            <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                            <span class="review">6 Comments</span>
                                    ...
                                    <div class="tab-pane m-t-20" id="recent">
                                        <div class="blog-post inner-bottom-30">
                                            <img class="img-responsive"
                                                src="<?php echo e(asset('app\images\blog-post\blog_big_03.jpg')); ?>"
                                                alt="">
                                            <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                            <span class="review">6 Comments</span>
                        ...
                        <div class="item m-t-15">
                            <a href="#" class="image">
                                <img data-echo="assets/images/brands/brand1.png"
                                    src="<?php echo e(asset('app\images\blank.gif')); ?>" alt="">
                            </a>
                        </div><!--/.item-->
