        ...
        <div class='row'>
            <div class='col-md-3 sidebar'>
                ...
                <div class="sidebar-module-container">
                    <div class="sidebar-filter">
                        ...
                        <!-- ============================================== PRICE SILDER============================================== -->
                        <form id="price-filter-form" method="GET" action="<?php echo e(route('filterProducts')); ?>" onsubmit="event.preventDefault(); filterProducts();">
                            <div class="sidebar-widget wow fadeInUp">
                                <div class="widget-header">
            ...
            <div class='col-md-9'>
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"> <img src="<?php echo e(asset('app\images\banners\cat-banner-1.jpg')); ?>" alt="" class="img-responsive"> </div>
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            ...
                                            <ul role="menu" class="dropdown-menu">
                                                <li role="presentation"><a class="dropdown-item" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'position', 'show' => request('show', 10)])); ?>">Position</a></li>
                                                <li role="presentation"><a class="dropdown-item" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'price_asc', 'show' => request('show', 10)])); ?>">Price: Lowest first</a></li>
                                                <li role="presentation"><a class="dropdown-item" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'price_desc', 'show' => request('show', 10)])); ?>">Price: Highest first</a></li>
                                                <li role="presentation"><a class="dropdown-item" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'name_asc', 'show' => request('show', 10)])); ?>">Product Name: A to Z</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            ...
                                            <ul role="menu" class="dropdown-menu" id="showDropdownMenu">
                                                <li role="presentation"><a class="dropdown-item" data-count="1" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 1])); ?>">1</a></li>
                                                <li role="presentation"><a class="dropdown-item" data-count="2" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 2])); ?>">2</a></li>
                                                <li role="presentation"><a class="dropdown-item" data-count="3" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 3])); ?>">3</a></li>
                                                <li role="presentation"><a class="dropdown-item" data-count="4" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 4])); ?>">4</a></li>
                                                <li role="presentation"><a class="dropdown-item" data-count="5" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 5])); ?>">5</a></li>
                                                <li role="presentation"><a class="dropdown-item" data-count="6" href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => request('sort', 'position'), 'show' => 6])); ?>">6</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="<?php echo e(url('detail/' . $product->id)); ?>">
                                                            ...
                                                            <img src="<?php echo e(asset("app/images/products/{$image->name}")); ?>" alt="">
                                                        </a>
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="<?php echo e(url('detail/' . $product->id)); ?>"><?php echo e($product->name); ?>

                                                        </a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                                    <div class="product-price"> <span class="price"> <?php echo e($product->price); ?> VND</span>
                                                ...
                                                <div class="cart clearfix animate-effect">
                                                    <div class="action">
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li class="lnk"> <a class="add-to-cart" href="<?php echo e(url('detail')); ?>" title="Compare"> <i class="fa fa-signal"></i> </a> </li>
                                                        </ul>
                                                    </div>
                                                    <!-- /.action -->
                                                </div>
