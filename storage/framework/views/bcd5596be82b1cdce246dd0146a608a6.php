                        ...
                        <div class="row  wow fadeInUp">
                            <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                                <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img style="width:100%" src="<?php echo e(asset("app/images/products/{$image->name}")); ?>"
                                        alt="">
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img
                                                        src="<?php echo e(asset('app\images\products\p4.jpg')); ?>"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img src="<?php echo e(asset('app\images\blank.gif')); ?>"
                                                        alt=""></a>
                                            </div><!-- /.image -->
