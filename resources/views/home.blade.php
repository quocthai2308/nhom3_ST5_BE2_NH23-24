                                                ...
                                                <div class="action">
                                                    <div class="add-cart-button btn-group">
                                                        ...
                                                        <button class="btn btn-primary cart-btn cooke"
                                                            data-id="{{ $product->id }}" type="button">Add to
                                                            cart</button>
                                                    </div>
                                                </div>
                                                <!-- /.action -->
                                                    ...
                                                    <div class="row product-micro-row">
                                                        <div class="col col-xs-5">
                                                            <div class="product-image">
                                                                <div class="image"> <a
                                                                        href="{{ url('detail/' . $specialProduct['id']) }}">
                                                        ...
                                                        <div class="col col-xs-7">
                                                            <div class="product-info">
                                                                <h3 class="name"><a
                                                                        href="{{ url('detail/' . $specialProduct['id']) }}">Floral
                                                                        Print
                                                                        Shirt</a></h3>
                                                                <div class="product-price"> <span class="price">
                    ...
                    <div class="sidebar-widget product-tag wow fadeInUp">
                        ...
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="tag-list"> <a class="item" title="Phone" href="{{ url('category') }}">Phone</a>
                                <a class="item active" title="Vest" href="{{ url('category') }}">Vest</a> <a
                                    class="item" title="Smartphone" href="{{ url('category') }}">Smartphone</a> <a
                                    class="item" title="Furniture" href="{{ url('category') }}">Furniture</a> <a
                                    class="item" title="T-shirt" href="{{ url('category') }}">T-shirt</a> <a
                                    class="item" title="Sweatpants" href="{{ url('category') }}">Sweatpants</a> <a
                                    class="item" title="Sneaker" href="{{ url('category') }}">Sneaker</a> <a
                                    class="item" title="Toys" href="{{ url('category') }}">Toys</a> <a class="item"
                                    title="Rose" href="{{ url('category') }}">Rose</a>
                            </div>
                            <!-- /.tag-list -->
                        </div>
                        <!-- /.sidebar-widget-body -->
                        ...
                        <div class="tab-content outer-top-xs">
                            <div class="tab-pane in active" id="all">
                                ...
                                <div class="product-info text-left">
                                    <h3 class="name"><a
                                            href="{{ url('detail/' . $newProduct['id']) }}">{{ $newProduct['name'] }}</a>
                                    </h3>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="add-cart-button btn-group">
                                                <button data-toggle="tooltip" class="btn btn-primary icon cooke"
                                                    data-id="{{ $newProduct['id'] }}" type="button" title="Add Cart">
                                                    <i class="fa fa-shopping-cart"></i>
                                                </button>
                                                <button class="btn btn-primary cart-btn add-to-cart"
                                                    data-id="{{ $newProduct['id'] }}" type="button">Add to cart</button>
                                            </li>
                                            <li class="lnk wishlist"> <a data-toggle="tooltip" class="add-to-cart"
                                                    href="{{ url('detail/' . $newProduct['id']) }}" title="Wishlist"> <i
                                                        class="icon fa fa-heart"></i> </a>
                                            </li>
                                            <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart"
                                                    href="{{ url('detail/' . $newProduct['id']) }}" title="Compare">
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    ...
                    <div class="tab-content outer-top-xs">
                        <div class="tab-pane in active" id="all">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a
                                        href="{{ url('detail/' . $newProduct['id']) }}">{{ $newProduct['name'] }}</a></h3>
                                <div class="description"><?php echo $newProduct['description']; ?></div>
                            ...
                            <div class="cart clearfix animate-effect">
                                <div class="action">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="add-cart-button btn-group">
                                            <button data-toggle="tooltip" class="btn btn-primary icon cooke"
                                                data-id="{{ $newProduct['id'] }}" type="button" title="Add Cart"> <i
                                                    class="fa fa-shopping-cart"></i>
                                            </button>
                                            <button class="btn btn-primary cart-btn add-to-cart cooke"
                                                data-id="{{ $newProduct['id'] }}" type="button">Add to cart</button>
                                        </li>
                                        <li class="lnk wishlist"> <a data-toggle="tooltip" class="add-to-cart"
                                                href="{{ url('detail/' . $newProduct['id']) }}" title="Wishlist"> <i
                        ...
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p5.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p6.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p8.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p9.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p10.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p11.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p12.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p13.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p14.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p15.jpg') }}" alt="image"></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p16.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p18.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p17.jpg') }}" alt=""></a> </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p14.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
    ...
    <div class="wide-banners wow fadeInUp outer-bottom-xs">
        <div class="row">
            <div class="col-md-7 col-sm-7">
                <div class="wide-banner cnt-strip">
                    <div class="image"> <img class="img-responsive"
                            src="{{ asset('app\images\banners\home-banner1.jpg') }}" alt=""> </div>
                </div>
                <!-- /.wide-banner -->
            </div>
            <!-- /.col -->
            <div class="col-md-5 col-sm-5">
                <div class="wide-banner cnt-strip">
                    <div class="image"> <img class="img-responsive"
                            src="{{ asset('app\images\banners\home-banner2.jpg') }}" alt=""> </div>
                </div>
                <!-- /.wide-banner -->
            </div>
            <!-- /.col -->
    ...
    <div class="wide-banners wow fadeInUp outer-bottom-xs">
        <div class="row">
            <div class="col-md-12">
                <div class="wide-banner cnt-strip">
                    <div class="image"> <img class="img-responsive"
                            src="{{ asset('app\images\banners\home-banner.jpg') }}" alt=""> </div>
                                        ...
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image"> <a href="{{ url('/detail/' . $product->id) }}">
                                                        <img src="{{ asset('app/images/products/' . $product->image_name) }}"
                                                            alt=""> </a> </div>
                                                <!-- /.image -->
...
>>>>>>> d8ae15b568f9dde682941a345b859196461ee54e
        </div>
    </div>
    </div>
    <!-- /.sidebar-widget-body -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p5.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p6.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p7.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p8.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p9.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p10.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p11.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p12.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p13.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p15.jpg') }}" alt="image"></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p16.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p18.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            <div class="product-image">
                                <div class="image"> <a href="{{ url('detail') }}"><img
                                            src="{{ asset('app\images\products\p17.jpg') }}" alt=""></a>
                                </div>
                                <!-- /.image -->
            ...
            <div class="owl-carousel blog-slider custom-carousel">
                    ...
                    <div class="blog-post">
                        <div class="blog-post-image">
                            <div class="image"> <a href="blog.html"><img
                                        src="{{ asset('app\images\blog-post\post1.jpg') }}" alt=""></a> </div>
                        </div>
                        <!-- /.blog-post-image -->
                ...
                <div class="item">
                    <div class="blog-post">
                        <div class="blog-post-image">
                            <div class="image"> <a href="blog.html"><img
                                        src="{{ asset('app\images\blog-post\post2.jpg') }}" alt=""></a> </div>
                        </div>
                        <!-- /.blog-post-image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p19.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p28.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p30.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p1.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p2.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="{{ url('detail') }}"><img
                                        src="{{ asset('app\images\products\p3.jpg') }}" alt=""></a> </div>
                            <!-- /.image -->
        ...
        <div class="logo-slider-inner">
            <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                <div class="item m-t-15"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand1.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->

                <div class="item m-t-10"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand2.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->

                <div class="item"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand3.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->

                <div class="item"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand4.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->

                <div class="item"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand5.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->

                <div class="item"> <a href="#" class="image"> <img
                            data-echo="assets/images/brands/brand6.png" src="{{ asset('app\images\blank.gif') }}"
                            alt=""> </a> </div>
                <!--/.item-->
