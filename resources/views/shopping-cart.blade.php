		...
		<table class="table">
			...
			@foreach ($cart as $productId => $product)
				<tr data-id="{{ $product['id'] }}">
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price" id="cart-sub-total-price-{{ $product['id'] }}">{{ $product['price'] }}</span></td>
					<td class="cart-product-grand-total"><span class="cart-grand-total-price" id="cart-grand-total-price-{{ $product['id'] }}">0</span></td>
				</tr>
				@endforeach
			</tbody><!-- /tbody -->
		</table><!-- /table -->
