                        ...
                        <div class="row  wow fadeInUp">
                            <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                                @foreach ($product->images as $image)
                                    <img style="width:100%" src="{{ asset("app/images/products/{$image->name}") }}"
                                        alt="">
                                @endforeach
                            </div><!-- /.gallery-holder -->
                            ...
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img src="{{ asset('app\images\products\p3.jpg') }}"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                                        ...
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img
                                                        src="{{ asset('app\images\products\p4.jpg') }}"
                                                        alt=""></a>
                                            </div><!-- /.image -->
