                            ...
                            <div class="product-info">
                                ...
                                <div class="stock-container info-container m-t-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="stock-box">
                                                <span class="value"><?php echo e($product->quantity); ?></span>
                                            </div>
                                        </div>
                                    </div><!-- /.row -->
                                </div><!-- /.stock-container -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="favorite-button m-t-10">
                                                ...
                                                <a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Add to Compare" href="<?php echo e(route('add.to.compare', ['id' => $product->id])); ?>">
                                                    <i class="fa fa-signal"></i>
                                                </a>
                                ...
                                <div class="quantity-container info-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <a href="#" class="btn btn-primary cooke" data-id="<?php echo e($product->id); ?>"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
                                        </div>
                ...
                <section class="section featured-product wow fadeInUp parent-review">
                    ...
                    <div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
                        <div class="item item-carousel">
                            <h4 class="user-name"><?php echo e($review->user_name); ?></h4>
                            <span style="font-weight: bold;"> <?php echo e($review->rating); ?></span>
                            <span style="color: yellow; font-size: 1.2em">★</span>
                            <p class="created_at"><?php echo e($review->created_at); ?></p>
